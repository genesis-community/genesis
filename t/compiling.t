...
output_ok "tar -tzvf test-1.0.4.tar.gz | awk '{print \$1, \$2, \$5, \$9}'", <<EOF, "tarball contents are correct";
drwxr-xr-x 0 0 test-1.0.4/
drwxr-xr-x 0 0 test-1.0.4/base/
-rw-r--r-- 0 28 test-1.0.4/kit.yml
-rw-r--r-- 0 15 test-1.0.4/base/params.yml
-rw-r--r-- 0 46 test-1.0.4/base/stuff.yml
EOF
qx(rm -f *.tar.gz *.tgz); # just to be safe
done_testing;
